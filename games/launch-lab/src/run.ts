...
/** Honest sample: aim through the first rings, launch once, let the capsule fly. */
export const SAMPLE_INPUTS = [
  { tick: 0, actionId: 1, value: 28 },
  { tick: 0, actionId: 2, value: 90 },
  { tick: 8, actionId: 4, value: 1 },
  { tick: 9, actionId: 4, value: 0 },
] as const;
