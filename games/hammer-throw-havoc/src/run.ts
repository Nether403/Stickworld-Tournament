...
export const SAMPLE_TICKS = 280;

/** Spin from tick 0, release at the forward phase (~tick 120). */
export const SAMPLE_INPUTS = [
  { tick: 0, actionId: 1, value: 1 },
  { tick: 120, actionId: 2, value: 1 },
  { tick: 121, actionId: 1, value: 0 },
  { tick: 121, actionId: 2, value: 0 },
] as const;
